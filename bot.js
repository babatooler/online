...
client7.login(process.env.TOKEN6);
client8.login(process.env.TOKEN7);
client9.login(process.env.TOKEN8);
client10.login(process.env.TOKE9);
client11.login(process.env.TOKEN10);
